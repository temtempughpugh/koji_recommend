...
export const DataTable: React.FC<DataTableProps> = ({ data }) => {
  ...
  const RecordFormDetail = ({ record }: { record: KojiRecord }) => {
    // デバッグ用：データを確認
    console.log('レコードデータ:', {
      time_2_3h_check: record.time_2_3h_check,
      time_before_handling: record.time_before_handling,
      ventilation_before_handling: record.ventilation_before_handling,
      exhaust_before_handling: record.exhaust_before_handling,
      dehumidifier_in_before_handling: record.dehumidifier_in_before_handling,
      dehumidifier_out_before_handling: record.dehumidifier_out_before_handling,
      airflow_before_handling: record.airflow_before_handling
    });
